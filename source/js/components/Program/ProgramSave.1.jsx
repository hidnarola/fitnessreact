    ...
    render() {
        ...
        return (
            <div className="fitness-body">
                ...
                <div className="workout-schedule-calendar-bulk-action-footer-wrap">
                    <div className="outer-layer">
                        <div className="inner-layer">
                            <div className="inner-layer-l">
                                <ul>
                                    <li></li>
                                    <li>
                                        <div className="inner-layer-l-content">
                                            ...
                                            <div className="content">
                                                <p>
                                                    <span>Workouts</span>
                                                    <span>
                                                        <a href="javascript:void(0)">Deselect</a>
                                                    </span>
                                                </p>
                                            </div>
                                        </div>
                            ...
                            <div className="inner-layer-r">
                                <div className="content-wrapper">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="javascript:void(0)">
                                                <i className="icon-check_circle"></i> Complete
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)">
                                                <i className="icon-cancel"></i> Incomplete
                                            </a>
                                        </li>
                                    </ul>
                                </div>
