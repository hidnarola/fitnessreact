...
class EquipmentsContentItem extends Component {
    ...
    componentWillMount() {
        ...
        this.setState({
            equipmentCheck: data.isAvailable ? true : false
        })
        change(data._id, data.isAvailable ? true : false);
    }

    componentWillReceiveProps(nextProps) {
        if (nextProps.data !== this.props.data) {
            this.setState({
                equipmentCheck: nextProps.data.isAvailable ? true : false
            })
            nextProps.change(nextProps.data._id, nextProps.data.isAvailable ? true : false);
        }
    }
