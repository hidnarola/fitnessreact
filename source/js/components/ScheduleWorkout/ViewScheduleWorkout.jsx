...
import {
    getUsersWorkoutScheduleRequest, changeWorkoutMainTypeDetails,
...
import WorkoutExercisesDetailsView from './WorkoutExercisesDetailsView';
...
class ViewScheduleWorkout extends Component {
    ...
    handleWorkoutMainTypeChange = (mainType) => {
        ...
        dispatch(changeWorkoutMainTypeDetails(mainType));
    }
}
...
const mapStateToProps = (state) => {
    ...
    return {
        ...
        selectedWorkoutMainTypeDetails: userScheduleWorkouts.get('selectedWorkoutMainTypeDetails'),
    };
}
