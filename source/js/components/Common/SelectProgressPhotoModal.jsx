...
class SelectProgressPhotoModal extends Component {
            ...
            <div className="progress-popup-body d-flex">
              ...
              <div className="crop-r">
                ...
                <div className="pregres-submit">
                  <button type="button" onClick={this.selectProgressImage}>
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      photoCategory &&
      prevProps.photoCategory &&
      photoCategory.value &&
      prevProps.photoCategory.value &&
      prevProps.photoCategory.value !== photoCategory.value
    ) {
    ...
    setTimeout(() => {
      try {
        ...
        let requrestData = {
          ...
          category:
            photoCategory && photoCategory.value ? photoCategory.value : null,
          subCategory:
            sub_category && sub_category.value ? sub_category.value : null
        };
        dispatch(addImageSelectedFromDetailsPage(requrestData));
      } catch (error) {
        te(
          "Invalid file selection for cropping. Please select jpg or png files."
        );
      } finally {
...
SelectProgressPhotoModal = connect(mapStateToProps)(SelectProgressPhotoModal);
