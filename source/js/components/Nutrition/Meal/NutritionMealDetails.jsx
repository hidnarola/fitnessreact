...
const renderSelectField = ({ input, meta, className, name, list = [] }) => {
  return (
...
const renderCheckBoxField = ({ input, meta, className, name, type, id }) => (
  <React.Fragment>
    <input
      {...input}
      type="checkbox"
            ...
            <div className="col-md-6">
              <div className="serves-box" style={{ marginLeft: "2px" }}>
                <div className="display-serve">
                  <div className="row no-gutters width-100-per d-flex flex-wrap align-items-center">
                    <div className="col-xs-12 col-lg-5">
                      <span className="serves-title">Difficulty</span>
                    </div>
                    <div className="col-xs-12 col-lg-7">
                      <div className="serving-select">
                        <Field
                          component={renderSelectField}
                          name="serving_difficulty"
                          className="form-control"
                          list={difficultyList}
                        />
                      </div>
            ...
            <div className="categories-body">
              <div className="row no-gutters width-100-per d-flex flex-wrap align-items-center">
                <div className="col-md-6">
                  <div className="categories-content">
                    <div className="categories-items d-flex flex-wrap width-100-per">
                      <div className="categories-title">Vegetarian</div>
                ...
                <div className="col-md-6">
                  <div className="categories-content">
                    <div className="categories-items d-flex flex-wrap width-100-per">
                      <div className="categories-title">Kosher</div>
                      <div className="custom-checkbox ml-auto">
                        <div className="custom_check mb-0">
                          <Field
                            component={renderCheckBoxField}
                ...
                <div className="col-md-6">
                  <div className="categories-content">
                    <div className="categories-items d-flex flex-wrap width-100-per">
                      <div className="categories-title">Vegan</div>
                      <div className="custom-checkbox ml-auto">
                        <div className="custom_check mb-0">
                          <Field
                            component={renderCheckBoxField}
                ...
                <div className="col-md-6">
                  <div className="categories-content">
                    <div className="categories-items d-flex flex-wrap width-100-per">
                      <div className="categories-title">Coelaic</div>
                      <div className="custom-checkbox ml-auto">
                        <div className="custom_check mb-0">
                          <Field
                            component={renderCheckBoxField}
                ...
                <div className="col-md-6">
                  <div className="categories-content">
                    <div className="categories-items d-flex flex-wrap width-100-per">
                      <div className="categories-title">Paleo</div>
                      <div className="custom-checkbox ml-auto">
                        <div className="custom_check mb-0">
                          <Field
                            component={renderCheckBoxField}
