            ...
            <div className="col-md-8">
              <div className="exercise-navbar">
                <div className="tabs sub-tab">
                  <div
                    className={
                      isActiveTab === `#details` ? 'tab  active' : 'tab'
                    }
                    onClick={() => this.handleChangeTab('#details')}
                  >
                    <a href="#details">Details</a>
                  </div>
                  <div
                    className={
                      isActiveTab === `#instructions` ? 'tab  active' : 'tab'
                    }
                    onClick={() => this.handleChangeTab('#instructions')}
                  >
                    <a href="#instructions">Instructions</a>
                  </div>
                  <div
                    className={isActiveTab === `#notes` ? 'tab  active' : 'tab'}
                    onClick={() => this.handleChangeTab('#notes')}
                  >
                    <a href="#notes">Notes</a>
                  </div>
                  <div
                    className={
                      isActiveTab === `#photos` ? 'tab  active' : 'tab'
                    }
