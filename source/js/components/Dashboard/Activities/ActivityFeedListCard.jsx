    ...
    return (
      <div className="post-type timeline-infinite-scroll">
        ...
        <div className="posttype-body">
              ...
              images.map((imageD, imageI) => {
                ...
                return (
                  <a
                    href="javascript:void(0)"
                    key={imageD._id}
                    onClick={() => this.handleOpenLightbox(images, imageI)}
                  >
                    <span>
                      <img
          ...
          {/* <div className="display-likes-status d-flex align-items-center">
                      <div style={{width: "35px",textAlign:"right"}}><i className="fad fa-comments-alt m-1" /></div>
                        <div className={cns("posttype-body-grey p-0")}><p className="p-0"><a href="#">Comments {totalComments}</a></p></div>
                    </div> */}
        ...
        {post &&
          ...
          post.friendshipStatus == FRIENDSHIP_STATUS_FRIEND && (
            <CommentBoxForm
              ref={this.commentBoxRef}
              postId={post._id}
              index={index}
...
export default connect(mapStateToProps)(ActivityFeedListCard);
