...
export const DELETE_USER_PERSONAL_GOAL_REQUEST =
  "DELETE_USER_PERSONAL_GOAL_REQUEST";
export const DELETE_USER_PERSONAL_GOAL_SUCCESS =
  "DELETE_USER_PERSONAL_GOAL_SUCCESS";
export const DELETE_USER_PERSONAL_GOAL_ERROR =
  "DELETE_USER_PERSONAL_GOAL_ERROR";

export function getUserPersonalGoalRequest(
  isCompleted = 0,
  start = 0,
  offset = 4
) {
...
export function addUserPersonalGoalRequest(requestData, callback = res => {}) {
  return {
