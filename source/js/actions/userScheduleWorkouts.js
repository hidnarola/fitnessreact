...
export const SET_SELECTED_SLOT_FROM_CALENDAR =
  "SET_SELECTED_SLOT_FROM_CALENDAR";

export const GET_USERS_WORKOUT_SCHEDULES_REQUEST =
  "GET_USERS_WORKOUT_SCHEDULES_REQUEST";
export const GET_USERS_WORKOUT_SCHEDULES_SUCCESS =
  "GET_USERS_WORKOUT_SCHEDULES_SUCCESS";
export const GET_USERS_WORKOUT_SCHEDULES_ERROR =
  "GET_USERS_WORKOUT_SCHEDULES_ERROR";

export const GET_USERS_WORKOUT_SCHEDULE_REQUEST =
  "GET_USERS_WORKOUT_SCHEDULE_REQUEST";
export const GET_USERS_WORKOUT_SCHEDULE_SUCCESS =
...
export const ADD_USERS_WORKOUT_SCHEDULE_REQUEST =
  "ADD_USERS_WORKOUT_SCHEDULE_REQUEST";
export const ADD_USERS_WORKOUT_SCHEDULE_SUCCESS =
  "ADD_USERS_WORKOUT_SCHEDULE_SUCCESS";
export const ADD_USERS_WORKOUT_SCHEDULE_ERROR =
  "ADD_USERS_WORKOUT_SCHEDULE_ERROR";

export const UPDATE_USERS_WORKOUT_SCHEDULE_REQUEST =
  "UPDATE_USERS_WORKOUT_SCHEDULE_REQUEST";
export const UPDATE_USERS_WORKOUT_SCHEDULE_SUCCESS =
  "UPDATE_USERS_WORKOUT_SCHEDULE_SUCCESS";
export const UPDATE_USERS_WORKOUT_SCHEDULE_ERROR =
...
export const DELETE_USERS_BULK_WORKOUT_SCHEDULE_REQUEST =
  "DELETE_USERS_BULK_WORKOUT_SCHEDULE_REQUEST";
export const DELETE_USERS_BULK_WORKOUT_SCHEDULE_SUCCESS =
  "DELETE_USERS_BULK_WORKOUT_SCHEDULE_SUCCESS";
export const DELETE_USERS_BULK_WORKOUT_SCHEDULE_ERROR =
  "DELETE_USERS_BULK_WORKOUT_SCHEDULE_ERROR";

export const DELETE_USER_WHOLE_EXERCISE_REQUEST =
  "DELETE_USER_WHOLE_EXERCISE_REQUEST";
export const DELETE_USER_WHOLE_EXERCISE_SUCCESS =
  "DELETE_USER_WHOLE_EXERCISE_SUCCESS";
export const DELETE_USER_WHOLE_EXERCISE_ERROR =
  "DELETE_USER_WHOLE_EXERCISE_ERROR";

export const DELETE_USER_SINGLE_EXERCISE_REQUEST =
  "DELETE_USER_SINGLE_EXERCISE_REQUEST";
export const DELETE_USER_SINGLE_EXERCISE_SUCCESS =
  "DELETE_USER_SINGLE_EXERCISE_SUCCESS";
export const DELETE_USER_SINGLE_EXERCISE_ERROR =
  "DELETE_USER_SINGLE_EXERCISE_ERROR";

export const COMPLETE_USERS_BULK_WORKOUT_SCHEDULE_REQUEST =
  "COMPLETE_USERS_BULK_WORKOUT_SCHEDULE_REQUEST";
export const COMPLETE_USERS_BULK_WORKOUT_SCHEDULE_SUCCESS =
  "COMPLETE_USERS_BULK_WORKOUT_SCHEDULE_SUCCESS";
export const COMPLETE_USERS_BULK_WORKOUT_SCHEDULE_ERROR =
  "COMPLETE_USERS_BULK_WORKOUT_SCHEDULE_ERROR";

export const INCOMPLETE_USERS_BULK_WORKOUT_SCHEDULE_REQUEST =
  "INCOMPLETE_USERS_BULK_WORKOUT_SCHEDULE_REQUEST";
export const INCOMPLETE_USERS_BULK_WORKOUT_SCHEDULE_SUCCESS =
  "INCOMPLETE_USERS_BULK_WORKOUT_SCHEDULE_SUCCESS";
export const INCOMPLETE_USERS_BULK_WORKOUT_SCHEDULE_ERROR =
  "INCOMPLETE_USERS_BULK_WORKOUT_SCHEDULE_ERROR";
...
export const UPDATE_USER_WORKOUT_TITLE_REQUEST =
  "UPDATE_USER_WORKOUT_TITLE_REQUEST";
export const UPDATE_USER_WORKOUT_TITLE_SUCCESS =
  "UPDATE_USER_WORKOUT_TITLE_SUCCESS";
export const UPDATE_USER_WORKOUT_TITLE_ERROR =
  "UPDATE_USER_WORKOUT_TITLE_ERROR";

export const CHANGE_WORKOUT_MAIN_TYPE = "CHANGE_WORKOUT_MAIN_TYPE";
export const CHANGE_WORKOUT_MAIN_TYPE_DETAILS =
  "CHANGE_WORKOUT_MAIN_TYPE_DETAILS";

export const GET_EXERCISE_MEASUREMENT_REQUEST =
  "GET_EXERCISE_MEASUREMENT_REQUEST";
export const GET_EXERCISE_MEASUREMENT_SUCCESS =
  "GET_EXERCISE_MEASUREMENT_SUCCESS";
export const GET_EXERCISE_MEASUREMENT_ERROR = "GET_EXERCISE_MEASUREMENT_ERROR";

export const PASTE_USERS_WORKOUT_SCHEDULE_REQUEST =
  "PASTE_USERS_WORKOUT_SCHEDULE_REQUEST";
export const PASTE_USERS_WORKOUT_SCHEDULE_SUCCESS =
  "PASTE_USERS_WORKOUT_SCHEDULE_SUCCESS";
export const PASTE_USERS_WORKOUT_SCHEDULE_ERROR =
  "PASTE_USERS_WORKOUT_SCHEDULE_ERROR";

export const CHANGE_USERS_WORKOUT_FORM_ACTION =
  "CHANGE_USERS_WORKOUT_FORM_ACTION";

export const GET_USER_FIRST_WORKOUT_BY_DATE_REQUEST =
  "GET_USER_FIRST_WORKOUT_BY_DATE_REQUEST";
export const GET_USER_FIRST_WORKOUT_BY_DATE_SUCCESS =
  "GET_USER_FIRST_WORKOUT_BY_DATE_SUCCESS";
export const GET_USER_FIRST_WORKOUT_BY_DATE_ERROR =
  "GET_USER_FIRST_WORKOUT_BY_DATE_ERROR";

export const GET_USER_WORKOUT_CALENDAR_LIST_REQUEST =
  "GET_USER_WORKOUT_CALENDAR_LIST_REQUEST";
export const GET_USER_WORKOUT_CALENDAR_LIST_SUCCESS =
  "GET_USER_WORKOUT_CALENDAR_LIST_SUCCESS";
export const GET_USER_WORKOUT_CALENDAR_LIST_ERROR =
  "GET_USER_WORKOUT_CALENDAR_LIST_ERROR";

export const GET_WORKOUTS_LIST_BY_DATE_REQUEST =
  "GET_WORKOUTS_LIST_BY_DATE_REQUEST";
export const GET_WORKOUTS_LIST_BY_DATE_SUCCESS =
  "GET_WORKOUTS_LIST_BY_DATE_SUCCESS";
export const GET_WORKOUTS_LIST_BY_DATE_ERROR =
...
export const REORDER_WORKOUT_EXERCISES_REQUEST =
  "REORDER_WORKOUT_EXERCISES_REQUEST";
export const REORDER_WORKOUT_EXERCISES_SUCCESS =
  "REORDER_WORKOUT_EXERCISES_SUCCESS";
export const REORDER_WORKOUT_EXERCISES_ERROR =
...
export function addUsersWorkoutScheduleRequest(
  requestData,
  callback = res => {}
) {
  return {
...
export function changeWorkoutMainType(
  mainType = SCHEDULED_WORKOUT_TYPE_WARMUP
) {
  return {
...
export function changeWorkoutMainTypeDetails(
  mainType = SCHEDULED_WORKOUT_TYPE_WARMUP
) {
  return {
...
export function deleteUserWholeExerciseRequest(
  requestData,
  callback = res => {}
) {
  return {
...
export function getUserWorkoutCalendarListRequest(
  requestData,
  username = null
) {
  return {
...
export function getWorkoutsListByDateRequest(requestData) {
  return {
    type: GET_WORKOUTS_LIST_BY_DATE_REQUEST,
    requestData
  };
}

export function getWorkoutsListByDateSuccess(data) {
  return {
    type: GET_WORKOUTS_LIST_BY_DATE_SUCCESS,
    data
  };
}

export function getWorkoutsListByDateError(error) {
  return {
    type: GET_WORKOUTS_LIST_BY_DATE_ERROR,
    error
  };
}
